...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgFilesTooLess: 'Usted debe seleccionar al menos <b>{n}</b> {files} a cargar. Por favor, intente cargarlo nuevamente!',
        msgFilesTooMany: 'El número de archivos seleccionados a cargar <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>. Por favor, intente cargarlo nuevamente',
        ...
        msgInvalidFileType: 'Tipo de archivo no válido para el archivo "{name}". Sólo archivos "{types}" son permitidos.',
        msgInvalidFileExtension: 'Extensión de archivo no válida para "{name}". Tenga en cuenta que solo se permiten los archivos "{extensions}".',
        msgValidationError: 'Ocurrió un error cargando el archivo',
